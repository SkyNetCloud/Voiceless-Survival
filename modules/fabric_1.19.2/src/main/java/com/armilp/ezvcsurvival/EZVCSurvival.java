...
public class EZVCSurvival implements ModInitializer {
    ...
    public void onInitialize() {
        ModLoadingContext.registerConfig(MOD_ID, COMMON, VoiceConfig.CONFIG, "ezvcsurvival/voices.toml");
        ModLoadingContext.registerConfig(MOD_ID, COMMON, SoundConfig.SPEC, "ezvcsurvival/sounds.toml");
